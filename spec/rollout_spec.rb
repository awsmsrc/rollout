...
describe 'Rollout' do
  ...
  describe 'activating a feature for a percentage of users' do
    ...
    it 'activates the feature for that percentage of the users' do
      (1..120).count { |id| @rollout.active?(:chat, stub(id: id)) }.should be_within(1).of(20)
    end
  end
  ...
  describe 'activating a feature for a percentage of users' do
    ...
    it 'activates the feature for that percentage of the users' do
      (1..200).count { |id| @rollout.active?(:chat, stub(id: id)) }.should be_within(5).of(40)
    end
  end
  ...
  describe 'activating a feature for a percentage of users' do
    ...
    it 'activates the feature for that percentage of the users' do
      (1..100).count { |id| @rollout.active?(:chat, stub(id: id)) }.should be_within(2).of(5)
    end
  end
