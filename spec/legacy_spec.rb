...
describe 'Rollout::Legacy' do
  ...
  describe 'activating a feature for a percentage of users' do
    ...
    it 'activates the feature for that percentage of the users' do
      (1..120).count { |id| @rollout.active?(:chat, stub(id: id)) }.should == 39
    end
  end
  ...
  describe 'activating a feature for a percentage of users' do
    ...
    it 'activates the feature for that percentage of the users' do
      (1..200).count { |id| @rollout.active?(:chat, stub(id: id)) }.should == 40
    end
  end
  ...
  describe 'activating a feature for a percentage of users' do
    ...
    it 'activates the feature for that percentage of the users' do
      (1..100).count { |id| @rollout.active?(:chat, stub(id: id)) }.should == 5
    end
  end
